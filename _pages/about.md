...
It is my honour to work under the supervision of [Prof. Ali Etemad, Ph.D.](https://www.aiimlab.com/director). My current research interests lie in the area of electroencephalography, brain computer interface (BCI), deep learning, semi-supervised learning and riemannian geometry. During the first 3 years PhD study, I **first authored** 8 papers (5 accepted, 3 journal submission under review at IEEE Transactions) with more than 100 citations. I have also been a reviewer of top-tier AI and EEG venues such as IEEE T-Cyb, IEEE T-NSRE, Pattern Recognit. (Elsevier), ICPR, ACII, SMC and AAAI worksop. 
